...
namespace example.y20211024
{
    ...
    public class ThrowController : MonoBehaviour
    {
        ...
        private MovementInput input;         // 输入系统
        private Rigidbody weaponRb;          // 武器上的刚体
        ...
        void Update()
        {
            ...
            // 有武器的情况下，按下鼠标右键，实现瞄准物体的效果，播放对应动画
        ...
        // 扔斧头，在Throw 动画上有对应的WeaponThrow 动画事件
